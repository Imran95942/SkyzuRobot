...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/d8ffceb79867115a7c874.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="http://t.me/BORZ_95_bot"),
        InlineKeyboardButton(
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/isIam07)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "http://t.me/BORZ_95_bot"
    try:
        messages = [
            m
